...
const createScene = function () {
    ...
    scene.clearColor = new BABYLON.Color4(0, 10, 0, 1);
    const camera = new BABYLON.ArcRotateCamera("camera", -Math.PI / 2, Math.PI / 2.5, 170, new BABYLON.Vector3(0, 100, 0));
    camera.setTarget(BABYLON.Vector3.Zero());
    camera.attachControl(canvas, false);


    const modelo3d = BABYLON.SceneLoader.ImportMesh("", "/img/", "Rio_paraguai_2.gltf", scene, function (newMeshes) {
